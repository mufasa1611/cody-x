import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@cody/sdk/v2"
import { SessionTurn } from "@cody/ui/session-turn"
import { SessionReview } from "@cody/ui/session-review"
import { DataProvider } from "@cody/ui/context"
import { FileComponentProvider } from "@cody/ui/context/file"
import { WorkerPoolProvider } from "@cody/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@cody/ui/logo"
import { IconButton } from "@cody/ui/icon-button"
import { ProviderIcon } from "@cody/ui/provider-icon"
import { iife } from "@cody/core/util/iife"
...
import { MessageNav } from "@cody/ui/message-nav"
import { FileSSR } from "@cody/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@cody/ui/pierre/worker").then((m) => ({
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/your-org/cody"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
