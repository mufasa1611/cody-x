...
It loads any matching `skills/*/SKILL.md` in `.cody/` and any matching `.claude/skills/*/SKILL.md` or `.agents/skills/*/SKILL.md` along the way.
...
Create `.cody/skills/git-release/SKILL.md` like this:
