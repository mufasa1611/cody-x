...
- Proje konfigurasyonu: `.cody/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.cody/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.
...
`.cody/skills/git-release/SKILL.md` dosyasini soyle olusturun:
