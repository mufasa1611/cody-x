...
- Prosjektkonfigurasjon: `.cody/skills/<name>/SKILL.md`
...
Den laster alle matchende `skills/*/SKILL.md` i `.cody/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.
...
Lag `.cody/skills/git-release/SKILL.md` slik:
