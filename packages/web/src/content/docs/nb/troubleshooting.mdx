...
Hvis du har `CODY_PORT` satt i miljøet ditt, vil skrivebordsappen prøve å bruke den porten for den lokale serveren.

- Deaktiver `CODY_PORT` (eller velg en ledig port) og start på nytt.
