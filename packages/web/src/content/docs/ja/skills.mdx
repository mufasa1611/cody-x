...
- プロジェクト設定: `.cody/skills/<name>/SKILL.md`
...
途中で、一致する `skills/*/SKILL.md` を `.cody/` に読み込み、一致する `.claude/skills/*/SKILL.md` または `.agents/skills/*/SKILL.md` を読み込みます。
...
次のように `.cody/skills/git-release/SKILL.md` を作成します。
