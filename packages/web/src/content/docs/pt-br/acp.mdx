...
Para abri-lo, use o novo agente 'cody' no seletor de agentes do AI Chat.
...
Se você precisar passar variáveis de ambiente (como `CODY_API_KEY`), consulte [Configurando Adaptadores: Variáveis de Ambiente](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) na documentação do CodeCompanion.nvim para detalhes completos.
