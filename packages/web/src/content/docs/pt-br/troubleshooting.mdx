...
Se você tiver `CODY_PORT` definido em seu ambiente, o aplicativo de desktop tentará usar essa porta para o servidor local.

- Desfaça `CODY_PORT` (ou escolha uma porta livre) e reinicie.
