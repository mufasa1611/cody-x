...
- Project config: `.cody/skills/<name>/SKILL.md`
...
Dabei werden passende `skills/*/SKILL.md` in `.cody/` sowie passende Dateien unter `.claude/skills/*/SKILL.md` und `.agents/skills/*/SKILL.md` geladen.
...
Erstelle `.cody/skills/git-release/SKILL.md` zum Beispiel so:
