...
Se hai `CODY_PORT` impostato nell'ambiente, l'app desktop provera a usare quella porta per il server locale.

- Rimuovi `CODY_PORT` (o scegli una porta libera) e riavvia.
