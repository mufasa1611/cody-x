...
Создайте `.cody/commands/test.md`:

```md title=".cody/commands/test.md"
---
...
- Для каждого проекта: `.cody/commands/`
...
```md title=".cody/commands/component.md"
---
...
```md title=".cody/commands/create-file.md"
---
...
```md title=".cody/commands/analyze-coverage.md"
---
...
```md title=".cody/commands/review-changes.md"
---
...
```md title=".cody/commands/review-component.md"
---
