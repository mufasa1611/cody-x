...
- Конфигурация проекта: `.cody/skills/<name>/SKILL.md`
...
Он загружает все соответствующие `skills/*/SKILL.md` в `.cody/` и все соответствующие `.claude/skills/*/SKILL.md` или `.agents/skills/*/SKILL.md` по пути.
...
Создайте `.cody/skills/git-release/SKILL.md` следующим образом:
