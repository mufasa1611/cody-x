...
Ładuje po drodze dowolne pasujące `skills/*/SKILL.md` w `.cody/` i dowolne pasujące `.claude/skills/*/SKILL.md` lub `.agents/skills/*/SKILL.md`.
...
Utwórz `.cody/skills/git-release/SKILL.md` w ten sposób:
