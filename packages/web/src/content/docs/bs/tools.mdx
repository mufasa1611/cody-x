...
:::note
Ovaj alat je dostupan samo kada je `CODY_EXPERIMENTAL_LSP_TOOL=true` (ili `CODY_EXPERIMENTAL=true`).
:::
...
:::note
Ovaj alat je dostupan samo uz OpenCode provajdera ili kada je varijabla `CODY_ENABLE_EXA` postavljena na truthy vrijednost (npr. `true` ili `1`).
