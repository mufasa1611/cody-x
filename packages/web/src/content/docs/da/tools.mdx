...
:::note
Dette verktøyet er bare tilgængelig når `CODY_EXPERIMENTAL_LSP_TOOL=true` (eller `CODY_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger OpenCode-leverandøren eller når miljøvariabelen `CODY_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
