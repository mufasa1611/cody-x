...
- การกำหนดค่าโครงการ: `.cody/skills/<name>/SKILL.md`
...
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.cody/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง
...
สร้าง `.cody/skills/git-release/SKILL.md` แบบนี้:
