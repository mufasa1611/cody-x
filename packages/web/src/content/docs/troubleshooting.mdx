...
If you have `CODY_PORT` set in your environment, the desktop app will try to use that port for the local server.

- Unset `CODY_PORT` (or pick a free port) and restart.
