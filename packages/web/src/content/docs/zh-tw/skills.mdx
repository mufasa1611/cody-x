...
- 專案設定：`.cody/skills/<name>/SKILL.md`
...
在此過程中，它會載入 `.cody/` 中所有匹配的 `skills/*/SKILL.md`，以及匹配的 `.claude/skills/*/SKILL.md` 或 `.agents/skills/*/SKILL.md`。
...
建立 `.cody/skills/git-release/SKILL.md`，內容如下：
