import { AppIcon } from "@cody/ui/app-icon"
...
import { Keybind } from "@cody/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_CODY_CHANNEL === "beta"
