export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by cody-x",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in cody-x.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.codyZen.line1":
    "cody-x gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in cody-x.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in cody-x.",
  ...
  "dialog.server.description": "Switch which cody-x server this app connects to.",
  ...
  "toast.update.description": "A new version of cody-x ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the cody-x team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, cody-x does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "cody-x includes free models so you can start immediately.",
  ...
  "app.name.desktop": "cody-x Desktop",
  ...
  "settings.desktop.wsl.description": "Run the cody-x server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for cody-x",
  ...
  "settings.general.row.appearance.description": "Customise how cody-x looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether cody-x follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how cody-x is themed.",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of cody-x.",
  ...
  "settings.agentConnect.description": "Connect to a remote PC using the cody-x agent. Run connect.mjs on the remote PC to establish a connection.",
