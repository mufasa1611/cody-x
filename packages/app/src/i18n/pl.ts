export const dict = {
  ...
  "dialog.provider.cody.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.cody.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.codyGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Cody Pro",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Cody Pro.",
  ...
  "provider.connect.codyZen.line1":
    "Cody Pro daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.codyZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.codyZen.visit.prefix": "Odwiedź ",
  "provider.connect.codyZen.visit.link": "provider portal",
  "provider.connect.codyZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Cody Pro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Cody Pro.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w cody.json",
  ...
  "dialog.server.description": "Przełącz serwer Cody Pro, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Cody Pro ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Cody Pro",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (cody.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Cody Pro zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Cody Pro",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Cody Pro na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Cody Pro ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Cody Pro.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Cody Pro",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Cody Pro.",
