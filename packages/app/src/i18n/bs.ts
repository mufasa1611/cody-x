export const dict = {
  ...
  "dialog.provider.cody.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.cody.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.codyGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Cody Pro",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Cody Pro-u.",
  ...
  "provider.connect.codyZen.line1":
    "Cody Pro ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.codyZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.codyZen.visit.prefix": "Posjeti ",
  "provider.connect.codyZen.visit.link": "provider portal",
  "provider.connect.codyZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Cody Pro-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Cody Pro-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u cody.json",
  ...
  "dialog.server.description": "Promijeni na koji se Cody Pro server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Cody Pro-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Cody Pro timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (cody.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Cody Pro još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Cody Pro uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Cody Pro server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Cody Pro-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Cody Pro izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Cody Pro prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Cody Pro-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Cody Pro pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Cody Pro-a.",
