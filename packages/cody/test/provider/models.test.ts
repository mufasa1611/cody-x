...
// test/preload.ts pins CODY_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.CODY_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.CODY_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.CODY_MODELS_PATH = undefined
  Flag.CODY_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.CODY_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.CODY_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
