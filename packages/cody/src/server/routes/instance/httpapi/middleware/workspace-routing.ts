...
>()("@cody/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@cody/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.CODY_WORKSPACE_ID ? WorkspaceID.make(Flag.CODY_WORKSPACE_ID) : undefined
}
