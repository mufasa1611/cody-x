...
export const InstanceRoutes = (upgrade: UpgradeWebSocket, opts?: CorsOptions): Hono => {
  ...
  if (Flag.CODY_EXPERIMENTAL_HTTPAPI) {
    ...
    app.get("/permission/mode", (c) => handler(c.req.raw, context))
    app.post("/permission/mode", (c) => handler(c.req.raw, context))
    app.get("/config", (c) => handler(c.req.raw, context))
    app.post("/agent/pair", (c) => handler(c.req.raw, context))
    app.get("/agent/status", (c) => handler(c.req.raw, context))
    app.get("/agent/fs/list", (c) => handler(c.req.raw, context))
    app.get("/agent/fs/read", (c) => handler(c.req.raw, context))
    app.post("/agent/fs/write", (c) => handler(c.req.raw, context))
    app.post("/agent/exec", (c) => handler(c.req.raw, context))
    app.post("/agent/disconnect", (c) => handler(c.req.raw, context))
  ...
  return app
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose the current cody-x instance, releasing all resources.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get paths",
        description: "Retrieve the current working directory and related path information for the cody-x instance.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all available commands in the cody-x system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List agents",
        description: "Get a list of all available AI agents in the cody-x system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List skills",
        description: "Get a list of all available skills in the cody-x system.",
