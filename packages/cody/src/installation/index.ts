...
export const USER_AGENT = `opencode/${InstallationChannel}/${InstallationVersion}/${Flag.CODY_CLIENT}`
  ...
  Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const getBrewFormula = Effect.fnUntraced(function* () {
        ...
        if (tapFormula.includes("cody")) return "anomalyco/tap/opencode"
      ...
      const result: Interface = {
        ...
        method: Effect.fn("Installation.method")(function* () {
          ...
          for (const check of checks) {
            ...
            const installedName =
              check.name === "brew" || check.name === "choco" || check.name === "scoop" ? "cody" : "opencode-ai"
