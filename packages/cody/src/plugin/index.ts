...
export class Service extends Context.Service<Service, Interface>()("@cody/Plugin") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Plugin.state")(function* (ctx) {
        ...
        const plugins = Flag.CODY_PURE ? [] : (cfg.plugin_origins ?? [])
        if (Flag.CODY_PURE && cfg.plugin_origins?.length) {
