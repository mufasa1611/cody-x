...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@cody/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@cody/ToolRegistry") {}
...
export const defaultLayer = <R>(fs: Layer.Layer<any, never, R> = AppFileSystem.defaultLayer) =>
  Layer.suspend(() =>
    layer.pipe(
