...
import previewLogoLight from "../../asset/brand/preview-cody-logo-light.png"
import previewLogoDark from "../../asset/brand/preview-cody-logo-dark.png"
import previewLogoLightSquare from "../../asset/brand/preview-cody-logo-light-square.png"
        ...
        <div data-component="content">
          <section data-component="brand-content">
            ...
            <button
              ...
              onClick={() => downloadFile(brandAssets, "cody-brand-assets.zip")}
            >
            ...
            <div data-component="brand-grid">
              <div>
                ...
                <div data-component="actions">
                  <button onClick={() => downloadFile(logoLightPng, "cody-logo-light.png")}>
                    PNG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
                  ...
                  <button onClick={() => downloadFile(logoLightSvg, "cody-logo-light.svg")}>
                    SVG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
              ...
              <div>
                ...
                <div data-component="actions">
                  <button onClick={() => downloadFile(logoDarkPng, "cody-logo-dark.png")}>
                    PNG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
                  ...
                  <button onClick={() => downloadFile(logoDarkSvg, "cody-logo-dark.svg")}>
                    SVG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
              ...
              <div>
                ...
                <div data-component="actions">
                  <button onClick={() => downloadFile(logoLightSquarePng, "cody-logo-light-square.png")}>
                    PNG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
                  ...
                  <button onClick={() => downloadFile(logoLightSquareSvg, "cody-logo-light-square.svg")}>
                    SVG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
              ...
              <div>
                ...
                <div data-component="actions">
                  <button onClick={() => downloadFile(logoDarkSquarePng, "cody-logo-dark-square.png")}>
                    PNG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
                  ...
                  <button onClick={() => downloadFile(logoDarkSquareSvg, "cody-logo-dark-square.svg")}>
                    SVG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
              ...
              <div>
                ...
                <div data-component="actions">
                  <button onClick={() => downloadFile(wordmarkLightPng, "cody-wordmark-light.png")}>
                    PNG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
                  ...
                  <button onClick={() => downloadFile(wordmarkLightSvg, "cody-wordmark-light.svg")}>
                    SVG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
              ...
              <div>
                ...
                <div data-component="actions">
                  <button onClick={() => downloadFile(wordmarkDarkPng, "cody-wordmark-dark.png")}>
                    PNG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
                  ...
                  <button onClick={() => downloadFile(wordmarkDarkSvg, "cody-wordmark-dark.svg")}>
                    SVG
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M13.9583 10.6247L10 14.583L6.04167 10.6247M10 2.08301V13.958M16.25 17.9163H3.75"
