...
OpenCode er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/your-org/cody/releases) eller [opencode.ai/download](https://opencode.ai/download).
...
1. `$CODY_INSTALL_DIR` - Egendefinert installasjonsmappe
...
Hvis du jobber med et prosjekt som er relatert til OpenCode og bruker "cody" som en del av navnet; for eksempel "opencode-dashboard" eller "opencode-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av OpenCode-teamet og ikke er tilknyttet oss på noen måte.
