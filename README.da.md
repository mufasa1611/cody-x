...
OpenCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/your-org/cody/releases) eller [opencode.ai/download](https://opencode.ai/download).
...
1. `$CODY_INSTALL_DIR` - Tilpasset installationsmappe
...
Hvis du arbejder på et projekt der er relateret til OpenCode og bruger "cody" som en del af navnet; f.eks. "opencode-dashboard" eller "opencode-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af OpenCode-teamet og ikke er tilknyttet os på nogen måde.
