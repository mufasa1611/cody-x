...
OpenCode 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/your-org/cody/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下载。
...
1. `$CODY_INSTALL_DIR` - 自定义安装目录
2. `$XDG_BIN_DIR` - 符合 XDG 基础目录规范的路径
3. `$HOME/bin` - 如果存在或可创建的用户二进制目录
4. `$HOME/.cody/bin` - 默认备用路径
