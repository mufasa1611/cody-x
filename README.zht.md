...
OpenCode 也提供桌面版應用程式。您可以直接從 [發佈頁面 (releases page)](https://github.com/your-org/cody/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下載。
...
1. `$CODY_INSTALL_DIR` - 自定義安裝目錄
2. `$XDG_BIN_DIR` - 符合 XDG 基礎目錄規範的路徑
3. `$HOME/bin` - 標準使用者執行檔目錄 (若存在或可建立)
4. `$HOME/.cody/bin` - 預設備用路徑
...
如果您正在開發與 OpenCode 相關的專案，並在名稱中使用了 "cody"（例如 "opencode-dashboard" 或 "opencode-mobile"），請在您的 README 中加入聲明，說明該專案並非由 OpenCode 團隊開發，且與我們沒有任何隸屬關係。
